...
class Crisper(sb.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        for i in range(0, len(channel_ids), channel_num_per_stem):
            ...
            # Process PCmic (channel 2) with Whisper
            ...
            # Calculate the loss between the target output and the other channels' output, already averaged channel by channel
        ...
        return total_loss/(loss_cnt*(channel_num_per_stem-1))*1000
