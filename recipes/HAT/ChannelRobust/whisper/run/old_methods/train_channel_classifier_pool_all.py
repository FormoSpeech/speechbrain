...
from ChannelRobust.whisper.run.scatteredness_utils import cal_scatteredness
...
class ASR(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        # mean_pooled_embeddings = torch.mean(enc_out[1:], axis=0).detach().cpu()
        ...
        # return cls_logits, wav_lens, mean_pooled_embeddings
