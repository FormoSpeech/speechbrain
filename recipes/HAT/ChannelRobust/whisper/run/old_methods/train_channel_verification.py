...
from ChannelRobust.whisper.run.scatteredness_utils import cal_scatteredness, plotTSNE
...
class ASR(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        # TODO: insert the t-SNE and scatteredness here, maybe save the embedding to each epoch
    ...
    def on_stage_end(self, stage, stage_loss, epoch):
        ...
        if stage == sb.Stage.VALID:
            ...
            scatteredness = cal_scatteredness(self.pooled_embedding_list)
            ...
            plotTSNE(self.pooled_embedding_list, self.hparams.output_folder)
...
def dataio_prep(hparams):
    ...
    # TODO: check label_encoder for each test_data
    test_datasets = {}
    ...
    label_encoder_stem.load_or_create(
        ...
        from_didatasets=[test_dataset_representation],
        output_key="stem",
    )
    
    
    # 4. Set output:
    sb.dataio.dataset.set_output_keys(datasets, ["id", "sig", "channel_id_encoded", "stem_encoded"])
...
if __name__ == "__main__":
    ...
    wandb.init(
        ...
        project="whisper-tiny-channel-verification",
