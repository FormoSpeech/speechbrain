...
if __name__ == "__main__":
    ...
    wandb.init(
        ...
        project=f"whisper-tiny-asr-{hparams['project']}{hparams['channel']}",
    ...
    # if os.path.exists(f"{hparams["output_cer_folder"]}/save/label_encoder.txt"):
    #     os.remove(f"{hparams["output_cer_folder"]}/save/label_encoder.txt")
