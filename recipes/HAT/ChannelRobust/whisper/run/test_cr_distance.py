...
class CRNet(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        for i in range(0, len(channel_ids), channel_num_per_stem):
            ...
            all_indices = [j for j in range(channel_num_per_stem)]
            ...
            wavs_all = wavs_stem[all_indices]
            bos_tokens_other = bos_tokens_stem[all_indices]
            ...
            if self.hparams.crNet_ckpt != False:
                enc_out_last = self.modules.crNet(enc_out_last)
...
if __name__ == "__main__":
    ...
    if hparams['crNet_ckpt'] != False:
        crNet.modules.crNet.load_state_dict(torch.load(hparams['crNet_ckpt']))
        logger.info(f"========================= Weight loaded from {hparams['crNet_ckpt'] } =========================")
