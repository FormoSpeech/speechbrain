'''
Model Structure:
    1. first use the output embedding with avery hidden to do adaptor as adaptive pooling
    2. connect to a classifier of 8 channel
'''
...
class Adaptor(nn.Module):
    ...
    '''
        ...
        output 256 dim
    '''
    def __init__(self, num_layers = 4, in_dim = 384, hidden_dim = 128, embedding_size = 256, dropout=0):
        super().__init__()
